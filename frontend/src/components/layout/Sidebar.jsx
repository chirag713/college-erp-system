...
export default function Sidebar({ role, activeTab, setActiveTab, handleLogout, user }) {
  const adminTabs = [
    ...
    { id: 'semesters', label: 'Semesters & Subjects', icon: BookMarked },
    { id: 'exams', label: 'Exams & Grades', icon: FileText },
    { id: 'calendar', label: 'Academic Calendar', icon: CalendarDays },
    { id: 'transport', label: 'Transport', icon: Building2 }, // Using building as a placeholder if Bus isn't imported
    ...
    { id: 'idcards', label: 'ID Cards', icon: IdCardIcon },
  ...
  const facultyTabs = [
    ...
    { id: 'assignments', label: 'Assignments (LMS)', icon: FileText },
    { id: 'exams', label: 'Exams & Grades', icon: FileText },
    { id: 'calendar', label: 'Academic Calendar', icon: CalendarDays },
  ...
  const studentTabs = [
    ...
    { id: 'semesters', label: 'My Subjects', icon: BookMarked },
    { id: 'assignments', label: 'Assignments (LMS)', icon: FileText },
    { id: 'exams', label: 'Exams & Grades', icon: FileText },
    { id: 'calendar', label: 'Academic Calendar', icon: CalendarDays },
    { id: 'transport', label: 'Transport', icon: Building2 },
    ...
    { id: 'alumni', label: 'Alumni Network', icon: GraduationCap },
    { id: 'certificates', label: 'Certificates', icon: Award },
    { id: 'idcards', label: 'My ID Card', icon: IdCardIcon },
    { id: 'documents', label: 'My Documents', icon: FolderOpen },
